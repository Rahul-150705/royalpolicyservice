...
const PollutionCenter = () => {
  return (
    <section id="pollution" className="py-20 md:py-28 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Content Side */}
          <div>
            <p className="text-accent font-semibold mb-2">🚗 Pollution Testing</p>
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card mb-8 border border-border/50">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="text-xl font-bold text-foreground">PUC Certificate</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" asChild>
                <a href="tel:+919344498444">Call: +91 9344498444</a>
              </Button>
            </div>
          </div>
